      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="ModifyItemList.do">信息</a></li>
            <li><a href="ModifyTeamInfo.do">游戏信息</a></li>
            <li><a href="getListOrderItemLst.do">주문정보</a></li>
            <!-- 
        ...
        <div class="col-md-16">
        	<table class="table">
	            <thead>
	              <tr>
	                <th>
	                	<button type="button" class="btn btn-secondary" onclick="createButton_onclikc()">添加</button>
	                </th>
	                <th>
	                ...
	                <th>
	                	<button type="button" class="btn btn-secondary" onclick="searchItemList()">查询</button>
	                </th>
	              </tr>
	            </thead>
        	</table>
            ...
            <c:forEach items ="${list2 }" var ="list2" varStatus="status">				
              <tr>
                ...
                <td>
                 ...
                 -->
                <td>
                	<button type="button" class="btn btn-primary" id="modifyButton${status.index}" onclick="modifyButton_onclikc(${status.index}, 'U')">修改</button>
                </td>
                <td>
                	<button type="button" class="btn btn-primary" id="deleteButton${status.index}" onclick="deleteButton_onclikc(${status.index})">删除</button>
                </td>
              </tr>
                	...
                	<input type="hidden" class='diaItemPriceNone' id="itemPriceC${status.index}" aria-describedby="passwordHelpBlock" value='${list2.ITEMPRICEC}' />
                	<input type="hidden" class='diaItemPriceNone' id="exgRate${status.index}" aria-describedby="passwordHelpBlock" value='${list2.EXGRATE}' />
			</c:forEach>
            </tbody>
          </table>
        </div>
...
<!-- 
  ...
  <script>
	...
	function searchItemList(){
  	...
  	totCnt = ${list2cnt};
  	// 수정 입력 호출
	function createButton_onclikcData(inkeyNum){
  		debugger;
		// form 변수 초기화
	...
	function createButton_onclikc(){
		...
		var tmpTExt = 	
            ...
            */
            + "    <td>                                                                                                                                   "
            + "    	<button type='button' class='btn btn-primary' id='modifyButton"+totCnt+"' onclick='createButton_onclikcData("+totCnt+")'>입력</button>                  "
            + "    </td>                                                                                                                                  "
            + "    <td>                                                                                                                                   "
            + "    	<button type='button' class='btn btn-primary' id='deleteButton"+totCnt+"' onclick=''>-</button>                   "
            + "    </td>                                                                                                                                  "
            + "  </tr>                                                                                                                                    "
            ...
            + "    	<input type='hidden' class='diaItemPriceNone' id='gameCode"+totCnt+"' aria-describedby='passwordHelpBlock' value='' />    "
            + "    	<input type='hidden' class='diaItemPriceNone' id='itemPriceC"+totCnt+"' aria-describedby='passwordHelpBlock' value='0' />    "
            + "    	<input type='hidden' class='diaItemPriceNone' id='exgRate"+totCnt+"' aria-describedby='passwordHelpBlock' value='0' />    "
            ;
