				...
				<table class="table table-bordered table-responsive-sm"
					...
					<tbody valign='bottom'>
							<tr style='font-size: 11px; text-align:center; vertical-align:middle'>
								...
								<!-- 상품명 -->
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='롯데칠성 아이시스 500ml 80개 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='23000 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='3000 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='수식 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='22800 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='20000 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='2800 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='19800 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
									<input id='PRODUCT_NM${list.DIDX}' value='링크 '/>
								</td>
								<td style='font-size: 11px; text-align:center; vertical-align:middle'>
	...
	<script>
		...
		function createButton_onclikc(){
			...
			var tmpTExt = 	
				...
				+ "	</td>"
				+ "	<td style='font-size: 11px; text-align:center; vertical-align:middle'>"
				+ "		<input type='text' class='diaItemPriceNone' id='PRODUCT_NM"+totCnt+"' value='' />"
				+ "	</td>"
				+ "	<td style='font-size: 11px; text-align:center; vertical-align:middle'>"
