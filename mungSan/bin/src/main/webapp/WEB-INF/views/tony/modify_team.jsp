    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">游戏信息 관리 페이지 </a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li ><a href="ModifyItemList.do">信息</a></li>
            <li class="active"><a href="ModifyTeamInfo.do">游戏信息</a></li>
        	...
        	<table class="table">
	            <thead>
	              <tr>
	                <!-- 
	                <th>
	                	<button type="button" class="btn btn-secondary" onclick="createButton_onclikc()">게임정보 신규추가</button>
	                </th>
	                <th>
          ...
          <table class="table table-bordered table-responsive-xl" id="itemTable">
            ...
            <c:forEach items ="${list3 }" var ="list3" varStatus="status">				
              <tr>
                ...
                <td>
                	<input type="text" class='diaItemPrice300' id="etc1${status.index}" aria-describedby="passwordHelpBlock" value='${list3.ETC1}' />
                </td>
                <td>
